...
class FinanceCompletedTicketListPage extends StatefulWidget {
  @override
  _MyManagerCompletedTicketListPageState createState() => _MyManagerCompletedTicketListPageState();
}

class _MyManagerCompletedTicketListPageState extends State<FinanceCompletedTicketListPage> {
  List<int> resource;
  ...
  Future getAllTicketList() async {
    http.Response response = await http
        .get(Uri.parse("https://ossms.com/management_api/Api/get_completed/3"));
