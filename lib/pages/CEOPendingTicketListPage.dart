...
class CEOPendingTicketListPage extends StatefulWidget {
  @override
  _MyCEOPendingTicketListPageState createState() => _MyCEOPendingTicketListPageState();
}

class _MyCEOPendingTicketListPageState extends State<CEOPendingTicketListPage> {
  List<int> resource;
  ...
  Future getAllTicketList() async {
    http.Response response = await http
        .get(Uri.parse("https://ossms.com/management_api/Api/get_pending/1"));
