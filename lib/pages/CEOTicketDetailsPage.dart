...
class CEOTicketDetailsPage extends StatefulWidget {
  final String ticketId;
  CEOTicketDetailsPage(this.ticketId, {Key key}) : super(key: key);

  @override
  _MyCEOTicketDetailsPageState createState() => _MyCEOTicketDetailsPageState();
}

class _MyCEOTicketDetailsPageState extends State<CEOTicketDetailsPage> {
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding:
                              const EdgeInsets.fromLTRB(8.0, 24.0, 20.0, 0.0),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Expanded(
...
class DetailScreenPage extends StatefulWidget {
  var resource;
  DetailScreenPage(this.resource, {Key key}) : super(key: key);
  @override
  _MyDetailScreenState createState() => _MyDetailScreenState();
}

class _MyDetailScreenState extends State<DetailScreenPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
