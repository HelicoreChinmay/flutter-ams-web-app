...
class FinancePendingTicketListPage extends StatefulWidget {
  @override
  _MyFinancePendingTicketListPageState createState() => _MyFinancePendingTicketListPageState();
}

class _MyFinancePendingTicketListPageState extends State<FinancePendingTicketListPage> {
  List<int> resource;
  ...
  Future getAllTicketList() async {
    http.Response response = await http
        .get(Uri.parse("https://ossms.com/management_api/Api/get_pending/3"));
