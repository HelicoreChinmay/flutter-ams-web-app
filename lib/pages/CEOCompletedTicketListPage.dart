...
class CEOCompletedTicketListPage extends StatefulWidget {
  @override
  _MyCEOCompletedTicketListPageState createState() => _MyCEOCompletedTicketListPageState();
}

class _MyCEOCompletedTicketListPageState extends State<CEOCompletedTicketListPage> {
  List<int> resource;
  ...
  Future getAllTicketList() async {
    http.Response response = await http
        .get(Uri.parse("https://ossms.com/management_api/Api/get_completed/1"));
