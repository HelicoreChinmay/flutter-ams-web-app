...
class ManagerTicketDetailsPage extends StatefulWidget {
  ...
  @override
  _MyManagerTicketDetailsPageState createState() => _MyManagerTicketDetailsPageState();
}
                                                        ...
                                                        onTap: () {
                                                          ...
                                                          Navigator.push(
                                                              ...
                                                              MaterialPageRoute(
                                                                  builder:
                                                                      (context) {
                                                            return ImageFullSizePage(resource);
                                                          }));
                                                        },
                                                        child: CircleAvatar(
                                                          radius: 60.0,
                                   ...
                                   Navigator.pushReplacement(
                                    ...
                                    MaterialPageRoute(
                                        builder: (BuildContext context) =>
                                            ManagerTicketDetailsPage(widget.ticketId)));
