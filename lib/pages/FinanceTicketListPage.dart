...
import 'package:flutter_ams/pages/FinanceTicketDetailsPage.dart';
import 'package:http/http.dart' as http;
import 'dart:developer';
import 'dart:convert';

class FinanceTicketListPage extends StatefulWidget {
  @override
  _MyFinanceTicketListPageState createState() => _MyFinanceTicketListPageState();
}

class _MyFinanceTicketListPageState extends State<FinanceTicketListPage> {
  List<int> resource;
                    ...
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => FinanceTicketDetailsPage(
