...
import 'package:flutter_ams/pages/ManagerTicketDetailsPage.dart';

class ManagerRaisedTicketsListPage extends StatefulWidget {
  @override
  _MyManagerRaisedTicketsListState createState() => _MyManagerRaisedTicketsListState();
}

class _MyManagerRaisedTicketsListState extends State<ManagerRaisedTicketsListPage> {
   List<int> resource;
                    ...
                    return InkWell(
                      onTap: () {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ManagerTicketDetailsPage(
