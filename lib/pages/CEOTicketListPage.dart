...
class CEOTicketListPage extends StatefulWidget {
  @override
  _MyCEOTicketListPage createState() => _MyCEOTicketListPage();
}

class _MyCEOTicketListPage extends State<CEOTicketListPage> {
  List<int> resource;
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return InkWell(
                      onTap: () {
                        ...
                        print("ticketId in inkwell = $ticketId");
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>
                                        CEOTicketDetailsPage(ticketId)));
                      },
                      child: Padding(
                        padding:
