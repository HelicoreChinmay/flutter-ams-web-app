...
class FinanceTicketDetailsPage extends StatefulWidget {
  final String ticketId;
  FinanceTicketDetailsPage(this.ticketId, {Key key}) : super(key: key);

  @override
  _MyFinanceTicketDetailsPageState createState() =>
      _MyFinanceTicketDetailsPageState();
}

class _MyFinanceTicketDetailsPageState extends State<FinanceTicketDetailsPage> {
