...
class ManagerPendingTicketListPage extends StatefulWidget {
  @override
  _MyManagerPendingTicketListPageState createState() => _MyManagerPendingTicketListPageState();
}

class _MyManagerPendingTicketListPageState extends State<ManagerPendingTicketListPage> {
  List<int> resource;
  ...
  Future getAllTicketList() async {
    http.Response response = await http
        .get(Uri.parse("https://ossms.com/management_api/Api/get_pending/2"));
